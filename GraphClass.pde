...
/*   =================================================================================       
    ...
    class Graph 
    {
      ...
      color   GraphColor;
      color   BackgroundColor=color(48);  
  ...
  //    int Peakcounter=0,nPeakcounter=0;
   ...
   /*  =========================================================================================
       ...
       ==========================================================================================  */
        ...
        fill(BackgroundColor); color(200);stroke(StrokeColor);strokeWeight(2);
        int t=80;
        
        rect(xPos-t*1.6,yPos-t,Width+t*2.5,Height+t*2, 20, 20, 20, 20);            // outline
        textAlign(CENTER);textSize(36);
        float c=textWidth(Title);
        fill(BackgroundColor); color(200);stroke(200);strokeWeight(2);
        rect(xPos+Width/2-c/2,yPos-28,c,0);                         // Heading Rectangle  
        ...
        textSize(20); noFill(); stroke(200); smooth();strokeWeight(2);
          //Edges
          ...
          for(int y=0; y<=yDiv; y++){
            ...
            if(RightAxis){
              ...
              color(GraphColor); stroke(200);fill(200);
   ...
   /*  =========================================================================================
      ...
      void LineGraph(float[] x ,float[] y) {
         ...
         for (int i=0; i<(x.length-1); i++){
                    strokeWeight(1.5);stroke(GraphColor);noFill();smooth();
